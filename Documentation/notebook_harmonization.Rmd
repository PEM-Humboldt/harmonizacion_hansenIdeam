...
mun <- st_read('/Users/sputnik/Library/CloudStorage/OneDrive-TempleUniversity/Research_Sommer_2023/harmonization_23/test_new/test_biomes.shp')
...
library(dplyr)
#load biomes map
mun <- vect(paste0(dir, 'test_new/test_biomes.shp'))
