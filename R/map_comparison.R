...
#Select those with actual data, drop all thata are only NAs. Of course there is a much better way to do this 
...
#this is old. I developed a much better way to do this. CompareClassification is from Greenbrown, it is deprectaed and very slow. 
